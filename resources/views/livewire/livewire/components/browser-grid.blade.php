<div class="h-full flex flex-col">
    ...
    @if(count($selected))
        ...
        <div class="mb-4 flex items-center justify-between rounded-lg border bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
    ...
    @if($assets->count())
        ...
        <div
            ...
            @foreach($assets as $asset)
                ...
                <livewire:asset-manager.asset-card
                    :asset="$asset"
                    :key="'asset-'.$asset->id"
                />
    ...
    @else
        ...
        <div
            class="flex h-[500px] flex-col items-center justify-center rounded-xl border border-dashed bg-white dark:border-gray-700 dark:bg-gray-800">

            <svg
                xmlns="http://www.w3.org/2000/svg"
                class="mb-4 h-20 w-20 text-gray-300"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor">
